...
[![loopchain](https://img.shields.io/badge/ICON-API-blue?logoColor=white&logo=icon&labelColor=31B8BB)](https://shields.io) [![GitHub Release](https://img.shields.io/github/release/sb-icon/icon-contracts.svg?style=flat)]() ![](https://github.com/sb-icon/icon-contracts/workflows/push-main/badge.svg?branch=main) [![codecov](https://codecov.io/gh/sb-icon/icon-contracts/branch/main/graph/badge.svg)](https://codecov.io/gh/sb-icon/icon-contracts)  ![](https://img.shields.io/github/license/sb-icon/icon-contracts)

[Live API Docs](https://tracker.icon.community/api/v1/contracts/docs/)

Off chain indexer for the ICON Blockchain serving the **contracts** context of the [icon-explorer](https://github.com/sb-icon/icon-explorer). Service is broken up into API and worker components that are run as individual docker containers. It depends on data coming in from [icon-go-etl](https://github.com/sb-icon/icon-go-etl) over a Kafka message queue with persistence on a postgres database.
